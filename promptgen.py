...
objadjcts = ['futuristic', 'glowing', 'ornate', 'scuffed', 'pristine', 'rustic', 'floral', 'crystalline', 'intricate', 'smooth', 'shiny', 'dusty', 'dirty', 'colorful', 'high-tech', 'modern', 'cute', 'magical', 'ancient', 'detailed', 'refined', 'unique', 'vintage', 'polished', 'elegant', 'sophisticated', 'complex', 'damaged', 'worn', 'weathered', 'archaic',]
...
objects = ['knife', 'weapon', 'flower', 'plushie', 'mirror', 'glass', 'silhouette', 'cape', 'backpack', 'dress', 'suit', 'bodysuit', 'artifact', 'map', 'fighter', 'sword', 'carbine', 'smartphone', 'book', 'walking stick', 'drink', 'lantern', 'mask', 'gas mask', 'hat', 'tattoos', 'guitar', 'crystal', 'gem',]
