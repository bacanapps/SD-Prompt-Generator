...
genadjcts = ['pretty', 'relaxing', 'calm', 'quiet', 'wonderful', 'nice', 'incredible', 'amazing', 'cozy', 'beautiful', 'ominous', 'gloomy', 'post-apocalyptic', 'warm', 'stunning', 'breathtaking', 'fascinating', 'peaceful', 'surreal', 'celestial', 'ancient', 'ethereal', 'dramatic', 'horrific', 'terrifying', 'emotional', 'dystopian', 'dark', 'magical', 'psychedelic', 'apocalyptic', 'fantasy', 'dark fantasy', 'alien', 'otherworldly', 'foggy', 'Victorian', 'trippy', 'desolate', 'eldritch', 'gothic', 'futuristic', 'snowy', 'fantastical', 'lush', 'mysterious', 'icy', 'fiery',]

objadjcts = ['futuristic', 'glowing', 'ornate', 'scuffed', 'pristine', 'rustic', 'floral', 'crystalline', 'intricate', 'smooth', 'shiny', 'dusty', 'dirty', 'colorful', 'high-tech', 'modern', 'cute', 'magical', 'ancient', 'detailed', 'refined', 'unique', 'vintage', 'polished', 'elegant', 'sophisticated', 'complex', 'damaged', 'worn', 'weathered']
...
objects = ['knife', 'weapon', 'flower', 'plushie', 'mirror', 'glass', 'silhouette', 'cape', 'backpack', 'dress', 'suit', 'bodysuit', 'artifact', 'map', 'fighter', 'sword', 'carbine', 'smartphone', 'book', 'walking stick', 'drink', 'lantern', 'mask', 'gas mask', 'hat', 'tattoos', 'guitar', 'crystal', 'gem', 'archaic',]

chara = ['man', 'woman', 'girl', 'boy', 'assassin', 'bounty hunter', 'knight', 'stormtrooper', 'robot', 'soldier', 'man', 'woman', 'samurai', 'vampire', 'catgirl', 'wolf girl', 'cowgirl', 'cowboy', 'jedi', 'warrior', 'sorcerer', 'human woman', 'human man', 'human girl', 'human boy', 'prince', 'princess', 'king', 'queen', 'god', 'goddess', 'demigod', 'survivor', 'villain', 'hero', 'traveler', 'spaceman', 'space marine', 'explorer', 'wayfarer', 'chef', 'bird', 'phoenix', 'swordsman', 'scout', 'schoolgirl', 'schoolboy', 'motorcyclist', 'monster', 'hunter', 'demon', 'angel', 'pilot', 'crewman', 'fox girl', 'wizard', 'emperor', 'viking', 'ninja', 'alien', 'businessman', 'guard', 'operative', 'scientist', 'police officer', 'serial killer', 'cultist', 'romantic couple', 'friends', 'spirit', 'crewwoman', 'Little Red Riding Hood', 'chancellor', 'cat', 'dog', 'frog',]
...
settings = ['street', 'beach', 'mountain', 'landscape', 'lake', 'planet', 'city', 'river', 'valley', 'house near a lake', 'house', 'house near the beach', 'skyscrapers', 'nature', 'town', 'forest', 'swamp', 'alien planet', 'urban landscape', 'natural landscape', 'alien landscape', 'street', 'city streets', 'town streets', 'liminal space', 'abandoned building', 'stronghold', 'thunderstorm', 'snowstorm', 'nature park', 'battlefield', 'castle', 'detailed background', 'epic sky', 'kitchen', 'bedroom', 'living room', 'office', 'outer space', 'throne room', 'cockpit', 'car', 'sports car', 'fighter', 'starship', 'fireplace', 'truck', 'cargo bay', 'space station', 'dock', 'meadow', 'stream', 'cave', 'stadium', 'alleyway', 'market', 'theater', 'workshop', 'field', 'farm', 'barn', 'path', 'jungle', 'pond', 'highway', 'underground cave', 'skyline', 'horizon', 'desert', 'mesa', 'misty island', 'Arctic landscape', 'cityscape', 'cottage', 'cabin in the woods', 'tunnel', 'hilly landscape', 'bathroom', 'village', 'dining room', 'hotel', 'library', 'Library of Alexandria', 'pyramids', 'shop', 'suburb', 'waterfall', 'pier', 'fountain', 'volcanic landscape', 'train', 'laboratory', 'boat', 'plane', 'haunted house', 'prison', 'factory']
